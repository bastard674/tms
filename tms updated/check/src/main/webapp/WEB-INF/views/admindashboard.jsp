...
<head>
    ...
    height: 330px;
    width: 100%;
    position: absolute; /* Make it absolute to move it freely */
    top: 120px; /* Adjust this value to control how high it appears */
...
.box3 {
    ...
    box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.1);
    text-align: center;
    height: 300px; /* Set a specific height for the box */
    width: 100%;
...
<br>
        ...
        <div class="container" id="boxContainer">
            ...
            <tbody id="tableBody">
                <!-- Empty rows will be dynamically added by JavaScript -->
            </tbody>
        </table>

        <br>

        <!-- Button to add new trainer row -->
        <button onclick="addTrainerRow()">Add Trainer</button>
    </div>
